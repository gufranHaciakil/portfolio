...
const Aboutmy = () => {
  return (
    <Container>
      <div id="about" className="flex justify-center items-center mx-auto">
        <div className="w-11/12 flex flex-col">
          <h1 className="font-bold text-2xl text-gray-800 w-fit">
            Frontend Developer
          </h1>
          ...
          <div className="flex gap-4 items-center mt-6">
            <a href="https://github.com/gufranHaciakil">
              <svg
            ...
            <a href="https://www.linkedin.com/in/gufran-haciakil-b347702b3/">
              <svg
                class="w-6 h-6 text-gray-800 dark:text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
